$vm.module_list={
    ...
    daily:                       ['--------','.../modules/daily.html','2',  'roster_record'],
    weekly:                      ['--------','.../modules/weekly.html','2', 'roster_record','daily'],
    monthly:                     ['--------','.../modules/monthly.html','2','roster_record','daily'],
    staff:                       ['20003869','.../modules/staff.html','2'],
    roster_record:               ['20006718','.../modules/roster_record.html','2','staff'],
